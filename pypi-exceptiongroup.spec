...
Source0  : https://files.pythonhosted.org/packages/a0/65/d66b7fbaef021b3c954b3bbb196d21d8a4b97918ea524f82cfae474215af/exceptiongroup-1.2.1.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.2.1
cd %{_builddir}/exceptiongroup-1.2.1
pushd ..
cp -a exceptiongroup-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713536308
