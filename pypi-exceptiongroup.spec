...
Source0  : https://files.pythonhosted.org/packages/cc/38/57f14ddc8e8baeddd8993a36fe57ce7b4ba174c35048b9a6d270bb01e833/exceptiongroup-1.1.1.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.1.1
cd %{_builddir}/exceptiongroup-1.1.1
pushd ..
cp -a exceptiongroup-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678720026
