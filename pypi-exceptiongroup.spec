...
%prep
%setup -q -n exceptiongroup-1.0.0rc8
cd %{_builddir}/exceptiongroup-1.0.0rc8
pushd ..
cp -a exceptiongroup-1.0.0rc8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656406277
...
cp %{_builddir}/exceptiongroup-1.0.0rc8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-exceptiongroup/084d0531a95caca443a618b31f06897d65dcb2e8
