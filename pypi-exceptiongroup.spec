...
Source0  : https://files.pythonhosted.org/packages/0b/9f/a65090624ecf468cdca03533906e7c69ed7588582240cfe7cc9e770b50eb/exceptiongroup-1.3.0.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.3.0
cd %{_builddir}/exceptiongroup-1.3.0
pushd ..
cp -a exceptiongroup-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747066606
