...
Source0  : https://files.pythonhosted.org/packages/09/35/2495c4ac46b980e4ca1f6ad6db102322ef3ad2410b79fdde159a4b0f3b92/exceptiongroup-1.2.2.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.2.2
cd %{_builddir}/exceptiongroup-1.2.2
pushd ..
cp -a exceptiongroup-1.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721061148
