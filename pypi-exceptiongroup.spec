...
Source0  : https://files.pythonhosted.org/packages/fa/e1/4f89a2608978a78876a76e69e82fa1fc5ce3fb346297eed2a51dd3df2dcf/exceptiongroup-1.0.4.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.0.4
cd %{_builddir}/exceptiongroup-1.0.4
pushd ..
cp -a exceptiongroup-1.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668525945
