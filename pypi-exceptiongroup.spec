...
Source0  : https://files.pythonhosted.org/packages/4f/7e/eca80dbb5c10ec12ffb50884f52ecbff653cb5f443b0529244a748f114da/exceptiongroup-1.0.0.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.0.0
cd %{_builddir}/exceptiongroup-1.0.0
pushd ..
cp -a exceptiongroup-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666879750
