...
Source0  : https://files.pythonhosted.org/packages/13/55/43ff6658a50a7f722d2f904810b42514c23a5d649d8a5d890cdc16b617de/exceptiongroup-1.0.1.tar.gz
...
%prep
%setup -q -n exceptiongroup-1.0.1
cd %{_builddir}/exceptiongroup-1.0.1
pushd ..
cp -a exceptiongroup-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667574736
